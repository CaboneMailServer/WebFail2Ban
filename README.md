...
- **[API Reference (OpenAPI)](https://petstore.swagger.io/?url=https://raw.githubusercontent.com/CaboneMailServer/WebFail2Ban/refs/heads/master/docs/api.json)** - Interactive API documentation with Swagger UI
